...
document.getElementById("btnLamlai").onclick = () => {
  document.getElementById("Th_Ho_ten").value = "";
  document.getElementById("Th_Email").value = "";
  document.getElementById("Th_Dien_thoai").value = "";
  document.getElementById("Th_Tieu_de").value = "";
...
document.getElementById("btnGoi").onclick = () => {
  ...
  apiLienhe(thongTin).then((result) => {
    ...
    if (result.Noi_dung) {
      ...
      alert(
        `Cám ơn bạn. Hiện tại việc gởi mail có sự cố, bạn có thể liên hệ với chúng tôi qua số hotline: 0909123456`
      );
    }
